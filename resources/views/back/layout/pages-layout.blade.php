...
<html>
	<head>
		...
		<link rel="stylesheet" href="/ijaboCropTool/ijaboCropTool.min.css">
	...
	<body>
		...
		<div class="left-side-bar">
			<div class="brand-logo">
				<a href="index.html">
					<img src="/img/site/{{ get_settings()->site_logo }}" alt="" class="dark-logo" />
					<img
						src="/img/site/{{ get_settings()->site_logo }}"
						alt=""
						class="light-logo"
					/>
				</a>
		...
		<script>
			if( navigator.userAgent.indexOf("Firefox") != -1 ){
				...
				I History.pushState(null, null, document.URL);
				});

			}
		</script>
		@livewireScripts
		<script src="/ijaboCropTool/ijaboCropTool.min.js"></script>
	@stack('scripts')
	</body>
</html>
